        ...
        <div className = 'w-full h-[50vh] nav' >
          <nav className = "w-full h-[70px] px-[14em] flex justify-between items-center" >
            ...
            <div className = "links-con flex items-center" >
              <div className = "links text mx-[2em] h-full gap-[2em] w-[34%] flex justify-between items-center">
            ...
            <img src = {menu} className = "hidden menu " />
          </nav>
          <div className = "text-stuff w-full h-full px-[18em] pt-[3em] flex">
            ...
            <div className = "text" >
              ...
              <p className = "text-xl font-medium para" >Fullstack Web Developer <br/> and Designer</p>
            </div>
          </div>
        </div>
